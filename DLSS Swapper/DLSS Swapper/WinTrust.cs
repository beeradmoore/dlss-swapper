...
namespace DLSS_Swapper
{
    ...
    internal static class WinTrust
    {
        ...
        public static bool VerifyEmbeddedSignature(string fileName)
        {
                ...
                */
                ...
                switch (lStatus)
                {
                    case WinVerifyTrustResult.ERROR_SUCCESS:
                        ...
                        */
                        validSignature = true;
                        Logger.Debug($"The file \"{fileName}\" is signed and the signature was verified.");
                        break;
                    ...
                    case WinVerifyTrustResult.TRUST_E_NOSIGNATURE:
                            ...
                            (uint)WinVerifyTrustResult.TRUST_E_PROVIDER_UNKNOWN == dwLastError)
                        {
                            ...
                            Logger.Debug($"The file \"{fileName}\" is not signed.");
                        }
                        else
                        {
                            // The signature was not valid or there was an error 
                            // opening the file.
                            Logger.Debug($"An unknown error occurred trying to verify the signature of the \"{fileName}\" file.");
                        }
                    ...
                    case WinVerifyTrustResult.TRUST_E_EXPLICIT_DISTRUST:
                        ...
                        Logger.Debug("The signature is present, but specifically disallowed.");
                        break;

                    case WinVerifyTrustResult.TRUST_E_SUBJECT_NOT_TRUSTED:
                        // The user clicked "No" when asked to install and run.
                        Logger.Debug("The signature is present, but not trusted.");
                        break;
                    ...
                    case WinVerifyTrustResult.CRYPT_E_SECURITY_SETTINGS:
                        ...
                        */
                        Logger.Debug("CRYPT_E_SECURITY_SETTINGS - The hash representing the subject or the publisher wasn't explicitly trusted by the admin and admin policy has disabled user trust. No signature, publisher or timestamp errors.");
                        break;

                    case WinVerifyTrustResult.CRYPT_E_FILE_ERROR:
                        //An error occurred while reading or writing to a file.
                        Logger.Debug("CRYPT_E_FILE_ERROR - An error occurred while reading or writing to a file.");
                        break;
                    ...
                    default:
                        ...
                        Logger.Debug($"Error is: 0x{lStatus}.");
                        break;
                }
            ...
            {
                Logger.Debug($"VerifyEmbeddedSignature Error: {err.Message}");
